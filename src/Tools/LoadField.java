            ...
            while ((s = read.readLine()) != null) {
                ...
                switch (objs[0]) // itt mindenbol uj van letrehozva, ezert ilyen hosszuak
                {
                    ...
                    case "a":
                        ...
                        break;
                    case "z":
                        data.collectables.addCollectable(new Coordinate(Integer.parseInt(objs[2]), Integer.parseInt(objs[1])), new ZPM());
                        break;
                    case "d":
                        this.addButtonDoor(read.readLine(), s);
                        break;
                    case "wl":
                        data.fields.addFieldObject(new Coordinate(Integer.parseInt(objs[2]), Integer.parseInt(objs[1])), new Wall());
                        break;
                    case "sw":
                        data.fields.addFieldObject(new Coordinate(Integer.parseInt(objs[2]), Integer.parseInt(objs[1])), new SpecialWall());
                        break;
                    case "bx":
                        data.boxes.addBox(new Coordinate(Integer.parseInt(objs[2]), Integer.parseInt(objs[1])), new Box());
                        data.buttons.EventOn(new Coordinate(Integer.parseInt(objs[2]), Integer.parseInt(objs[1])), data.boxes.isThereV2(new Coordinate(Integer.parseInt(objs[2]), Integer.parseInt(objs[1]))));
                        break;
                    case "wy":
                        data.fields.addFieldObject(new Coordinate(Integer.parseInt(objs[2]), Integer.parseInt(objs[1])), new Way());
                        break;
